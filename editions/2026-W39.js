   ...
   "stories": [
    ...
    },
    {
     ...
     "figure": {
      ...
      "caption": "A · Cases and controls (bar to scale). B · Each cell is one non-HLA risk region; teal, lead variants also associated with insulin-secretion or insulin-resistance indices. C · Bayesian fine-mapping with three annotation strategies; enrichment for DNase hypersensitivity, active histone marks and chromatin states in bulk Roadmap tissues; schematic. D · Functional work mostly in rodent beta-cell models. Data: Fu et al., Diabetologia, 2026.",
      "steps": [
